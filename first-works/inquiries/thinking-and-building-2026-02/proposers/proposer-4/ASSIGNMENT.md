...
Save your proposals to: `/atlantis/philosophy/inquiries/thinking-and-building-2026-02/approach-selection/proposals/proposer-4-proposals.md`

Use this format:

```markdown
# Approach Proposals from proposer-4
...
cd /atlantis/philosophy && bd close ph-2nj.6

# 2. Signal completion
export ATLANTIS_AGENT_NAME=proposer-4
atlantis-mail send convener "PROPOSER_DONE proposer-4" "Proposals complete"
