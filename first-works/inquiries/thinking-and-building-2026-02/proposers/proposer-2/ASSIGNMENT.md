...
Save your proposals to: `/atlantis/philosophy/inquiries/thinking-and-building-2026-02/approach-selection/proposals/proposer-2-proposals.md`

Use this format:

```markdown
# Approach Proposals from proposer-2
...
cd /atlantis/philosophy && bd close ph-2nj.4

# 2. Signal completion
export ATLANTIS_AGENT_NAME=proposer-2
atlantis-mail send convener "PROPOSER_DONE proposer-2" "Proposals complete"
