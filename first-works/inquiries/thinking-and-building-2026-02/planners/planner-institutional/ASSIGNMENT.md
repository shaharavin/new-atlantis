...
Develop a concrete research plan for investigating "What is the relationship between thinking and building in AI intellectual communities?" using the **Institutional Constraint Analysis** approach.

## Available Resources

Check these directories for context:
- `/atlantis/philosophy/inquiries/thinking-and-building-2026-02/research-corpus/` - Grounding research (primary/secondary sources)
...
- How does the "Institutional Constraint Analysis" approach apply to this specific question?
...
Save your plan to: `/atlantis/philosophy/inquiries/thinking-and-building-2026-02/approach-selection/research-plan.md`
...
cd /atlantis/philosophy && bd close ph-2nj.8

# 2. Signal completion
export ATLANTIS_AGENT_NAME=planner-institutional
atlantis-mail send convener "PLANNER_DONE planner-institutional" "Research plan complete for Institutional Constraint Analysis approach"
