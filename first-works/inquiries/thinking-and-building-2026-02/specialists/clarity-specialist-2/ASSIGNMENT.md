...
**Your name**: clarity-specialist-2
**Specialty**: clarity
**Iteration**: 2
**Work bead**: ph-2nj.15
...
Read: `/atlantis/philosophy/inquiries/thinking-and-building-2026-02/drafts/draft-2.md`
...
Save your critique to: `/atlantis/philosophy/inquiries/thinking-and-building-2026-02/critiques/iteration-2/clarity-specialist-2-critique.md`

Structure your critique as:

```markdown
# clarity Critique (Iteration 2)

**Specialist**: clarity-specialist-2
...
cd /atlantis/philosophy && bd close ph-2nj.15

# 2. Signal completion
export ATLANTIS_AGENT_NAME=clarity-specialist-2
atlantis-mail send convener "SPECIALIST_DONE clarity-specialist-2" "Critique complete: clarity iteration 2"
